...
#grid_file="/users/gogerb/domain1_DOM01.nc"
...
!----------------------------------------------------------------------------------
&Process
  in_file = "/scratch/gogerb/inidata/20190913/laf2019091300"
  in_model_name="cosmo"
  out_type = "INCORE"
/
...
!----------------------------------------------------------------------------------
&Process
  in_file = "/scratch/gogerb/inidata/19091300/eas20${date}"
  out_type="INCORE"
/
...
&Process
  in_file = "/scratch/gogerb/inidata/19091300/efsf<DDHH>0000"
  out_regrid_target = "icon_grid,multiple,${lateral_boundary_grid_file}"
  out_regrid_method = "default"
  out_file = "${wd}/efsf<DDHH>0000_lbc.nc",
  out_type = "NETCDF", out_type_ncaspect = "icon", out_type_ncnodegendim=.TRUE.
